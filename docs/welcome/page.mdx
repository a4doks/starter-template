...
5. **Local Preview**: Experience the blend of markdown and shadcn locally with the A4Doks CLI.
6. **One-Click Deployment**: Deploy your enriched documentation site to our cloud in a snap via the A4Doks CLI.
7. **Light and Dark Mode**: Switch between themes for the ideal reader experience.
